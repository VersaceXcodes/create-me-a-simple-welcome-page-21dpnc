...
export default tool({
  ...
  execute: async ({ featureId, message }) => {
    const response = await fetch("https://launchpulse.ai/api/project/create-me-a-simple-welcome-page/features/progress", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        projectId: "create-me-a-simple-welcome-page",
        token: "lp_createme_646dc21ff8d64706",
        featureId: featureId,
        passes: true,
